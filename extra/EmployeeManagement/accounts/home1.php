...
<body>
    ...
    <form  class="form-inline" id="admin1" method="POST" action="#" style="display: none;">
        <h2 style="color:rgb(153, 47, 153);margin-top:-450px;margin-left:350px;">View Profile</h1> <br>
             <div class="scrollbar" class="style-1">
                <label>Emp Name <span style="color:red">*</span>:</label>
        ...
        $(document).ready(
            ...
            $('#viewprofileofadmin').on('click',function(){
                ...
                var dataString2 = '&empname1='+ empname1 + '&empid1='+ empid1 + '&email1='+ email1 + '&designation1='+ designation1 + 
                                  '&mobile1='+ mobile1 + '&alternatenumber1='+ alternatenumber1 + '&doj1='+ doj1 + '&dob1='+ dob1 + '&qualification1='+ qualification1
                 ...
                 $("#submitbutton").click(
                    function(e){
                       ...
                       $(".modal").modal('hide');
                        ...
                        $.ajax({type: "POST",
                        url: "http://localhost/EmployeeManagement/accounts/taskvalidation.php",
                        data: "task="+c,
                        cache: false,
                             success: function(result){
...
$('#addprofile').click(function() {
    ...
    // alert('hiii');
                ...
                var dataString1 = '&empname2='+ empname + '&empid2='+ empid + '&email2='+ email+ '&designation2='+ designation + 
                                ...
                                '&qualification2='+ qualification+ '&gender2='+ gender +'&presentaddress2='+ presentaddress +
                                '&permanentaddress2='+ permanentaddress + '&maritalstatus2='+ maritalstatus +
                                '&department2='+ department+'&adminprivileges2='+ adminprivileges;
                    // AJAX Code To Submit Form.
                    $.ajax({
                        type: "POST",
